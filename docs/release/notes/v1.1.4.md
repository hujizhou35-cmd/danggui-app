...
> 此版本已由 [v1.1.5 稳定版](https://github.com/hujizhou35-cmd/danggui-app/releases/tag/v1.1.5)取代。新安装和升级请使用 v1.1.5；本页面保留用于历史核对。
>
> This release has been superseded by the [v1.1.5 Stable Release](https://github.com/hujizhou35-cmd/danggui-app/releases/tag/v1.1.5). Use v1.1.5 for new installations and upgrades; this page remains available for historical verification.
