...
- Android 精确闹钟直接进入前台响铃服务，不再依赖易丢失的 Receiver 中转；旧 v1.1.3 已登记闹钟保留一版兼容。
...
- Android exact alarms now enter the foreground ringing service directly instead of relying on a fragile receiver hand-off. Existing v1.1.3 broadcast alarms remain compatible for one release.
